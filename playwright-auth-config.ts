 ...
 *
 * @param headless - Whether to run in headless mode (default: false for debugging)
 * @returns BrowserContext with your existing authentication sessions
 */
export async function createAuthenticatedBrowser(headless: boolean = false): Promise<BrowserContext> {
